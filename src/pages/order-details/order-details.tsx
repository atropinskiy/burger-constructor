  ...
  return (
    <div className={s.order__details__div}>
      ...
      <div className={`${s.order__details__ingredients}`}>
        {groupedIngredients.map((ingredient) => (
          <div key={ingredient._id} className={s.ingredient}>
            <img src={ingredient.image_mobile} alt={ingredient.name} className={s.ingredient__image} />
      ...
      <div className='d-flex w-100 mt-10'>
        ...
        <p className='ml-auto d-flex valign-center text text_type_digits-default'>{totalPrice}<CurrencyIcon className="ml-1" type="primary" /></p>
      </div>
    </div>
  );
};
